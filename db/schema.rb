...
ActiveRecord::Schema[7.0].define(version: 2022_10_31_091648) do
  ...
  create_table "privatemessages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recip_id"], name: "index_privatemessages_on_recip_id"
  ...
  create_table "taglists", force: :cascade do |t|
    ...
    t.bigint "tag_id"
    t.bigint "gosssip_id"
    t.index ["gosssip_id"], name: "index_taglists_on_gosssip_id"
    t.index ["tag_id"], name: "index_taglists_on_tag_id"
  end
